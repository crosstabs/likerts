...
| iOS / Android / Flutter | iOS Swift Git tag `0.1.0`; [Flutter `0.0.3` on pub.dev](https://pub.dev/packages/likerts/versions/0.0.3); Android `com.likerts:likerts-android:0.0.3` from Maven Central. See [installation](../../sdks/INSTALLATION.md). SDK packages do not imply a consumer app. |
