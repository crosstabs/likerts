...
export const examples={
  ...
  billing_checkout_get:entry({id:'123e4567-e89b-12d3-a456-426614174010'},{"id":"123e4567-e89b-12d3-a456-426614174010","amountCents":500,"responseCredits":500,"status":"paid","checkoutUrl":null},'Poll the workspace-owned purchase after return. Only signed provider events mark it paid; read usage for the current balance after refunds or consumption.'),
