...
const processServer=spawn(`${root}backend/target/debug/likerts-server`,[],{env:{...process.env,LIKERTS_PORT:String(port),LIKERTS_ALLOW_MEMORY:'1',LIKERTS_DEV_TOKENS:JSON.stringify({[token]:'choices'})},stdio:['ignore','ignore','pipe']});
