...
## Install the local 0.0.2 artifact

This local package supports schemas 1–4. The release manifest records artifact and clean-install verification; frozen 0.0.1 artifacts remain available separately.

Extract `likerts-android-maven-0.0.2.tar.gz` and add its `maven/` directory to the host project's dependency repositories:
